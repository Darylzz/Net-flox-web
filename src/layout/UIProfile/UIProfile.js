        ...
        <div className="UIProfileCon">
          ...
          >
            ...
            <div className="UIProfileNavLeft">
                <Link style={{textDecoration: "none", color: "#fff"}} to="/">Action</Link>
                <Link style={{textDecoration: "none", color: "#fff"}} to="/">Comedy</Link>
                <Link style={{textDecoration: "none", color: "#fff"}} to="/">Romantic</Link>
                <Link style={{textDecoration: "none", color: "#fff"}} to="/">Kid</Link>
            </div>
